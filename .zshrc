# Load some local environment data
...
# Load dircolors
eval `dircolors ~/Workspace/apps/dircolors-solarized/dircolors.256dark`
...
if [ -n "$WSL_DISTRO_NAME" ]; then
    # seems to run every 10s, called by p9k_worker
    # echo "Running scripts for WSL environment"
    #bash ${HOME}/Workspace/apps/ZpidTools/scripts/run-clean-tmp-dir-for-wsl.sh
fi
